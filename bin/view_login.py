...
class View(object):
    ...
    def __init__(self, master, controller):
        ...
        self.__teacher_button = Button(self.__window, text="Teacher", command= lambda: self.__model_teacher.viewSubject(self.__Entry_name, self.__Entry_surname, controller))
        self.__student_button = Button(self.__window, text="Student", command= lambda: self.__model_student.viewSubject(self.__Entry_name, self.__Entry_surname, controller))
